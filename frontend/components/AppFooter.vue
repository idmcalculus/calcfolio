  ...
  <footer class="mt-10 border-t border-gray-300 dark:border-gray-700">
    ...
    <div class="bg-red-500 py-3">
      <div class="container mx-auto max-w-(--breakpoint-xl) px-6 flex justify-center items-center gap-5">
        ...
        <a href="https://x.com/calculus_codes" target="_blank" rel="noopener noreferrer" aria-label="X" class="text-white hover:text-gray-200 transition">
          <Icon name="simple-icons:x" size="24" />
        </a>
        <a href="https://instagram.com/idmcalculus" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="text-white hover:text-gray-200 transition">
          <Icon name="simple-icons:instagram" size="24" />
        </a>
        <a href="https://linkedin.com/in/idmcalculus" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" class="text-white hover:text-gray-200 transition">
